...
dependency configurations, and CI runs both (see *Dependency boundaries*): 1142
passed / 2 skipped with the extras installed, 1000 / 144 with core dependencies
only (2026-09-25, measured locally for hub B-245 on `5e3c0c1`, branched from
...
`380a7a4` before it, measured the same four ways, as B-201 measured them with
`main` `0235487` merged in; 1106 / 1 and 965 / 142 for B-243 on `d53f403`, its
merge of `main` `66ad1a3`, whose tests `main` `0235487` merged unchanged, and
