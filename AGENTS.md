...
dependency configurations, and CI runs both (see *Dependency boundaries*): 1369
passed / 1 skipped with the extras installed, 1228 / 142 with core dependencies
only (2026-09-25, measured locally for hub B-360 on its tree, branched from
...
rather than skipped; the jump is `tests/test_validator_parity.py`'s 285
parametrised cases); 1066 / 1 and 925 / 142
