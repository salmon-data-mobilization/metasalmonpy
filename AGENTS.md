...
only (2026-09-24, measured locally for hub B-241 under Python 3.11.15, pytest
9.1.1 and pandas 3.0.6, on a machine where `Rscript` is on `PATH` and
`/tmp/metasalmon-lib` exists; 1012 / 1 and 871 / 142 for B-242 and 1007 / 1 and
866 / 142 for B-240 earlier that day, 966 / 1 and 825 / 142 for B-191 on
2026-09-23, 951 / 1 and
