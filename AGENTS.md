...
`python -m pytest -q` and bare `pytest -q`; 1142 / 2 and 1001 / 143 for B-370
on `b40ed2a`, branched from `main` `380a7a4`, and 1141 / 2 and 1000 / 143 for
B-244 on `4722f17`, its merge of the same `main`, whose tests `main` `056fccc`
merged unchanged; 1140 / 2 and 999 / 143 on `main` `380a7a4` before them,
measured the same four ways, as for B-201 with `main`
