...
dependency configurations, and CI runs both (see *Dependency boundaries*): 1088
passed / 1 skipped with the extras installed, 947 / 142 with core dependencies
only (2026-09-25, measured locally for hub B-243 on `c4bdfb9`, branched from
...
branched from `main` `dcafe28`; 1064 / 1 and 923 / 142 on
